...
<img align="right" width="55%" src="docs/img/save-padding.gif"/>

### Deck tweets

Upon pressing the bookmark button, you'll now be prompted to add the tweet to one or more decks.

> **Note**: this isn't a requirement; tweets are still bookmarked when you press the button, though you *will* save time by doing the sorting beforehand.
